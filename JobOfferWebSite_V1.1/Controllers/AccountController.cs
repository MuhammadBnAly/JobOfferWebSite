...
namespace WebApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Governorate = new SelectList(new[] { "القاهرة", "الأسكندرية", "المنوفية", "الغربية", "الدقهلية", "القليوبية", "البحيرة", "الأقصر", "أسوان", "أسيوط", "المنيا", "دمياط" });
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.msg = "كلمة السر الحالية غير صحيحة";
            }
            else
            {
